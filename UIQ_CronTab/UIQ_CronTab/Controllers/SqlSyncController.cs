...
namespace UIQ_CronTab.Controllers
{
    ...
    [ApiController]
    public class SqlSyncController : ControllerBase
    {
        ...
        public SqlSyncController(IEnumerable<IDataBaseService> dataBaseServices, ISshCommandService sshCommandService, IConfiguration configuration)
        {
        ...
        [HttpPost]
        public async Task Post([FromBody] SqlSyncRequest request)
        {
